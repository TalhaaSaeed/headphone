    ...
    <>
      <section>
        <div className="container py-14 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 gap-12">
          {/* ___________Banner Image___________ */}
          <div>
            <motion.img
          ...
          {/* ___________Banner Text___________ */}
          <div className="flex flex-col justify-center">
            ...
            "
              >
                The Leatest Headphones With The Leatest Technology
              </motion.h1>
              <motion.p
                variants={fadeUp(0.9)}
                initial="hidden"
              ...
              >
                ...
                Voluptate, est enim? Doloribus animi recusandae quaerat?
              </motion.p>
              <UpdateFollower
                mouseOptions={{
